...
internals.manifest = {
    ...
    register: {
            ...
            plugin:'crumb',
                options: {
                    ...
                    skip: function(request, reply) {
                        if (request.path && request.path.indexOf('/v1/') > -1) {
                            return true;
                        }
                    }
            }
        ...
        {
            /* Version v1 apis */
            plugin: '@routes/web_api/v1/products.js'
        },
        /* ----------------- Start third-party api routes -------------- */
        {
            /* Version v1 apis */
            plugin: '@routes/thirdPartyApi/elevania/v1/products.js'
        },

        /* ----------------- End third-party apiroutes  -------------- */
